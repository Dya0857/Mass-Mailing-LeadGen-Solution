    ...
    <div className="register-wrapper">
      ...
      <div className="register-left">
        <div className="register-card">
          ...
          <p className="reg-subtitle">Get started with Mass Mailer in seconds</p>
      ...
      {/* RIGHT SECTION BEAUTIFUL PANEL */}
      <div className="register-right">
        <h1>Automate Your Email Marketing</h1>
        <p style={{color:"white"}}>Generate leads, manage outreach & send bulk emails effortlessly.</p>
